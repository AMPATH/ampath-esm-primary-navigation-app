 ...
 * @returns
 */ export function useOpenmrsPagination(url, pageSize, options = {}) {
    return useServerPagination(url, pageSize, openmrsServerPaginationHandlers, options);
}
export const openmrsServerPaginationHandlers = {
...
export function useServerPagination(url, pageSize, serverPaginationHandlers, options = {}) {
