...
import { type SWRInfiniteConfiguration, type SWRInfiniteResponse } from 'swr/infinite';
import { type ServerPaginationHandlers, type OpenMRSPaginatedResponse } from './useOpenmrsPagination';
